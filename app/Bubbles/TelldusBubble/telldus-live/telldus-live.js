...
var DEFAULT_LOGGER = {
    error   : function (msg, props) { console.log(msg); if (!!props) console.log(props); }
...
TelldusAPI.prototype.setSensorName = function (sensor, name, callback) {
    return this.roundtrip('PUT', '/sensor/setName?' + querystring.stringify({
        id        : sensor.id
        , name      : name
    }), callback);
};
...
TelldusAPI.prototype.getDeviceInfo = function (device, callback) {
    return this.roundtrip('GET', '/device/info?' + querystring.stringify({
        id               : device.id
...
TelldusAPI.prototype.addDevice = function (device, clientID, name, protocol, model, callback) {
    return this.roundtrip('POST', '/device/setName?' + querystring.stringify({
        id        : device.id
        , name      : name
        , protocol  : protocol
        , model     : model
...
TelldusAPI.prototype.setDeviceModel = function (device, model, callback) {
    return this.roundtrip('PUT', '/device/setModel?' + querystring.stringify({
        id        : device.id
        , model     : model
    }), callback);
};
...
TelldusAPI.prototype.setDeviceName = function (device, name, callback) {
    return this.roundtrip('PUT', '/device/setName?' + querystring.stringify({
        id        : device.id
        , name      : name
    }), callback);
};
...
TelldusAPI.prototype.setDeviceParameter = function (device, parameter, value, callback) {
    return this.roundtrip('PUT', '/device/setParameter?' + querystring.stringify({
        id        : device.id
        , parameter : parameter
        , value     : value
    }), callback);
...
TelldusAPI.prototype.setDeviceProtocol = function (device, protocol, callback) {
    return this.roundtrip('PUT', '/device/setProtocol?' + querystring.stringify({
        id        : device.id
        , protocol  : protocol
    }), callback);
};
...
TelldusAPI.prototype.commandDevice = function (device, method, value, callback) {
    ...
    return this.roundtrip('PUT', '/device/command?' + querystring.stringify({
        id        : device.id
...
TelldusAPI.prototype.dimDevice = function (device, level, callback) {
    return this.roundtrip('PUT', '/device/dim?' + querystring.stringify({
        id        : device.id
        , level     : level
    }), callback);
};
